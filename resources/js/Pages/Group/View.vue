            ...
            <div class="group relative bg-white">
                ...
                <div class="flex">
                    ...
                    <div class="flex justify-between items-center flex-1 p-4">
                        ...
                        <PrimaryButton @click="joinToGroup" v-if="authUser && !group.role && group.auto_approval">Join to Group</PrimaryButton>
                        <PrimaryButton @click="joinToGroup" v-if="authUser && !group.role && !group.auto_approval">Request to join</PrimaryButton>
                    </div>
                </div>
            </div>
            <div class="border-t">
...
const aboutForm = useForm({
    ...
    about: usePage().props.group.description
})
