...
<template>
    ...
    <div @click="$emit('attachmentClick',ind)" class="cursor-pointer group aspect-square bg-blue-100 flex flex-col items-center justify-center text-gray-500 relative ">
